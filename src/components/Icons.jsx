...
export const ScreenIcon = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
    <rect x="6.5" y="2.5" width="11" height="19" rx="2.5" />
    <path strokeLinecap="round" d="M10.5 5.25h3" />
  </svg>
)
...
export const BatteryIcon = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
    ...
    <path strokeLinecap="round" d="M21.5 10.5v3" />
...
export const BackGlassIcon = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
    <rect x="6.5" y="2.5" width="11" height="19" rx="2.5" />
...
export const ChargingPortIcon = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 16.5h6M12 16.5V21M8 9.5h8a1.5 1.5 0 0 1 1.5 1.5v2A3.5 3.5 0 0 1 14 16.5h-4A3.5 3.5 0 0 1 6.5 13v-2A1.5 1.5 0 0 1 8 9.5Z" />
    <path strokeLinecap="round" d="M10 9.5V7M14 9.5V7" />
  </svg>
)

export const ButtonIcon = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
